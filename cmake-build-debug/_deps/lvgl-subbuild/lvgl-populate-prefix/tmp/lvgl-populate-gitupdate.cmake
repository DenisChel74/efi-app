...
execute_process(
  COMMAND "/usr/bin/git" show-ref "release/v8.2"
  WORKING_DIRECTORY "/home/hermione/CLionProjects/EFIFrontend/cmake-build-debug/_deps/lvgl-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release/v8.2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release/v8.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/release/v8.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hermione/CLionProjects/EFIFrontend/cmake-build-debug/_deps/lvgl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hermione/CLionProjects/EFIFrontend/cmake-build-debug/_deps/lvgl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
